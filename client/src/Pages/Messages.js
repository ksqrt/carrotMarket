...
import {sendMessage, sendFile, disconnect, getUserConversations, initializeSocket, setAppointment, deleteAppointment, appointmentCheck, ReportMessage, ExitRoom, TradeComplete} from '../services/messagesData';
                                    ...
                                    <Form.Group>
                                        <InputGroup style={{ display: 'flex', alignItems: 'center' }}>
                                            ...
                                            <button type="button" className={`${styles['menu-item']} ${styles.blue}`} onClick={() => document.getElementById("uploadInput").click()}> 
                                                ...
                                                {/* <input type="file" name='image' id="uploadInput" onClick={handleFileSelect} style={{display: 'none'}} /> */}
